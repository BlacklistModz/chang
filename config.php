...
define('URL', 'http://localhost/php/chang/');

define('DB_TYPE', 'mysql');
define('DB_HOST', 'localhost');
define('DB_NAME', 'chang');
define('DB_USER', 'root');
define('DB_PASS', '');
...
define('RECAPTCHA_SITE_KEY', '6LcBqDQUAAAAALzK7Soz9-1glzoJLrbi5UjcPE8U');
define('RECAPTCHA_SECRET_KEY', '6LcBqDQUAAAAALiGvMI6cPVQasZXdLxXFWsAMn_2');
