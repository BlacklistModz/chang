...
if ( !empty($this->item['permit']['del']) ) {
	...
	$arr['form'] = '<form class="js-submit-form" action="'.URL. 'products/del_weight"></form>';
	$arr['hiddenInput'][] = array('name'=>'id','value'=>$this->item['id']);
	$arr['body'] = "คุณต้องการลบ <span class=\"fwb\">\"DW : {$this->item['dw']} , NW : {$this->item['nw']}\"</span> หรือไม่?";
	...
	$arr['body'] = "คุณไม่สามารถลบ <span class=\"fwb\">\"DW : {$this->item['dw']} , NW : {$this->item['nw']}\"</span> ได้?";	
